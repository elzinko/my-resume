...
| 3.2 | **Mobile : sous-blocs à écart uniforme** — l'espace au-dessus d'Agile == au-dessus de Dev == de Ops, calé sur l'écart titre→texte (via `#domains` margin-top négatif + body-gap).                                  | complet mobile | 🧪     |
