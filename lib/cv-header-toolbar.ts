...
const iconShell =
  `inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-md border border-slate-400/40 bg-white text-slate-600 shadow-sm transition-all duration-200 ease-out ${focusRing}`;
...
const modeShell =
  `inline-flex h-8 items-center gap-1 rounded-md border border-slate-400/40 bg-white px-2 text-xs font-medium text-slate-600 shadow-sm transition-all duration-200 ease-out md:gap-2 md:px-3 md:text-sm ${focusRing}`;
 ...
 */
export const cvHeaderLocaleSwitchBtn =
  `inline-flex h-8 w-8 shrink-0 overflow-hidden rounded-md border border-blue-500/45 bg-blue-50/90 p-0 shadow-sm transition-all duration-200 ease-out ${focusRing} hover:border-blue-600/60 hover:bg-blue-100 hover:shadow-md active:scale-[0.96] motion-reduce:active:scale-100`;
