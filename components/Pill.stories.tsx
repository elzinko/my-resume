...
const meta: Meta<typeof Pill> = {
  ...
  argTypes: {
    color: {
      control: 'select',
      options: ['fuchsia', 'orange', 'skill', 'jobs', 'domain', 'education', 'match'],
    },
...
export const MatchWithMetric: Story = { args: { color: 'match', children: 'React', metric: '4 ans' } };
export const MatchClientBadge: Story = { args: { color: 'match', children: 'BlaBlaCar', size: 's', border: false } };
...
export const AllVariants: Story = {
  render: () => (
    <div className="flex flex-wrap gap-3">
      ...
      <Pill color="match" metric="4 ans">React</Pill>
      <Pill color="match" size="s" border={false}>BlaBlaCar</Pill>
  ...
  render: () => (
    <div className="space-y-4">
      <div className="flex flex-wrap items-baseline gap-2">
        <Pill color="match" metric="10 ans">Java</Pill>
        <Pill color="match" size="s" border={false}>BlaBlaCar</Pill>
        <Pill color="match" size="s" border={false}>SNCF</Pill>
        <Pill color="match" size="s" border={false}>Ecocea</Pill>
      </div>
      <div className="flex flex-wrap items-baseline gap-2">
        <Pill color="match" compact metric="4 ans">React</Pill>
        <Pill color="match" compact metric="2 ans">Node.js</Pill>
      </div>
      <div className="flex flex-wrap items-baseline gap-2">
        <Pill color="match" size="l" metric="10 ans">Java</Pill>
      </div>
    </div>
  ),
};
